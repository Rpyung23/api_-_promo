...
app.post("/static",async function(req,res)
{
    try {
        ...
        data1.cant_cupon_ocp = data2.cant_cupon_ocp != undefined && data2.cant_cupon_ocp != null ? parseInt(data2.cant_cupon_ocp) : 0
        data1.disponible_cupon_ocp = data2.disponible_cupon_ocp != undefined && data2.disponible_cupon_ocp != null ? parseInt(data2.disponible_cupon_ocp) : 0
        data1.tot_ocp =  data2.tot_ocp != undefined && data2.tot_ocp != null ? parseInt(data2.tot_ocp) : 0

        res.status(200).json({
            status_code : 200,
            msm : "OK",
            cant_cupon_vn: (data1.tot_vn/data1.cant_cupon_vn)*100,
            disponible_cupon_vn: (data1.tot_vn/data1.disponible_cupon_vn)*100,
            tot_vn: data1.tot_vn,
            cant_cupon_ocp: (data2.tot_ocp/data2.cant_cupon_ocp)*100,
            disponible_cupon_ocp: (data2.tot_ocp/data2.disponible_cupon_ocp)*100,
